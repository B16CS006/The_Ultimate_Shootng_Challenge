...
public:
    ...
    void set_coordinate(int,int);      				//for changing the position of shooter_ box & shooter
...
score::score():life(3),current_score(0),high_score(1000){};
...
inline void score::update(){current_score+=5;}
